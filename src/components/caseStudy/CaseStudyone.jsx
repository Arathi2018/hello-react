    ...
    return (
        <div className="text-3xl font-bold text-white w-full">
            <div className="w-full !h-full max-h-[450px] mb-6 justify-items-center">
                <img src="/images/banner.webp" alt="Case Study Image" className="w-full h-full mb-6"/>
            </div>
            <div className="container max-w-3/4 w-full mx-auto">
                ...
                <img src="/images/stage3.webp" alt="Case Study Image" className="w-full h-full mb-6"/>
                ...
                <img src="/images/stage2.webp" alt="Case Study Image" className="w-full h-full mb-6"/>
                ...
                <img src="/images/stage4.webp" alt="Case Study Image" className="w-full h-full mb-6"/>
                ...
                <p className="text-[16px] text-white font-normal text-base/7 mb-4">The app was built on a scalable design system with a cohesive blue-anchored color palette, clean hierarchical typography, and standardized reusable components ensuring visual consistency across every screen while streamlining the developer handoff process.</p>
                 <img src="/images/stage5.webp" alt="Case Study Image" className="w-full h-full mb-6"/>
                ...
                <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center justify-between mb-4 pt-4 border-t border-[#343434] pb-4">
                   ...
                   <Link to="/case-study/food-delivery-app" className="flex items-center gap-2 border border-[#484848] bg-[#1A1A1A] px-4 py-3 rounded-full text-white text-[16px] font-normal">View Next <GoArrowUpRight /></Link>
                </div>
            </div>
        </div>
    )
