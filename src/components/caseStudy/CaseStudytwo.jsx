    ...
    return (
        <div className="text-3xl font-bold text-white w-full">
            <div className="w-full !h-full max-h-[450px] mb-6 justify-items-center">
                <img src="/images/banner2.jpg" alt="Case Study Image" className="w-full h-full mb-6"/>
            </div>
            <div className="container max-w-3/4 w-full mx-auto">
                ...
                <div className="flex flex-col gap-3 w-full h-full mb-6">
                    <img src="/images/user-persona1.jpg" alt="Case Study Image" className="w-full h-full mb-6"/>
                    <img src="/images/user-persona2.jpg" alt="Case Study Image" className="w-full h-full mb-6"/>
                </div>
                ...
                <img src="/images/stage31.jpg" alt="Case Study Image" className="w-full h-full mb-6"/>
                ...
                <img src="/images/stage32.jpg" alt="Case Study Image" className="w-full h-full mb-6"/>
